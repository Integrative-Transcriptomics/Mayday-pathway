...
public class LeftTransitive  extends AbstractEdgeRouter
{
	...
	{
		Point2D s=new Point2D.Double(source.getBounds().getMinX(), source.getBounds().getCenterY());
		Point2D t=new Point2D.Double(target.getBounds().getMinX(), target.getBounds().getCenterY());
	...
	public PluginInfo register() throws PluginManagerException 
	{
		PluginInfo pli = new PluginInfo(
				this.getClass(),
				"PAS.GraphViewer.EdgeRouter.LeftTransitive",
				new String[]{},
				MC,
				new HashMap<String, Object>(),
				"Stephan Symons",
				"symons@informatik.uni-tuebingen.de",
				"Transtive edges (left)",
				"Transitive (left)"				
		);
		return pli;
	}
