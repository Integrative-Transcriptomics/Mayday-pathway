...
public class QTClustering extends AbstractGraphViewerPlugin 
{
	@Override
	public void run(final GraphViewerPlot canvas, GraphModel model, List<CanvasComponent> components) 
	{
		...
		Thread RunPluginThread = new Thread("QtClustering")
		{
			public void run() {
				...
				ProbelistPlugin km=(ProbelistPlugin) PluginManager.getInstance().getPluginFromID("PAS.clustering.qt").getInstance();
	...
	public PluginInfo register() throws PluginManagerException 
	{
		PluginInfo pli = new PluginInfo(
				this.getClass(),
				"PAS.GraphViewer.QtCluster",
				new String[]{},
				GraphViewerPlugin.MC_GRAPH,
				new HashMap<String, Object>(),
				"Stephan Symons",
				"symons@informatik.uni-tuebingen.de",
				"Cluster the Probes using QT Clustering  ",
				"Quality based (QT)"				
		);
		pli.setIcon("mayday/pathway/gvicons/qt.png");
